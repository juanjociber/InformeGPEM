...
<html lang="es">
  ...
  <body>
    ...
    <div class="container">
          ...
          <div class="custom-select-wrapper">
            ...
            <div id="supervisorList" class="custom-select-list">
              ...
              <?php foreach ($supervisores as $supervisor): ?>
                <div class="custom-select-item" data-value="<?php echo htmlspecialchars($supervisor['supervisor']); ?>"><?php echo htmlspecialchars($supervisor['supervisor']); ?></div>
              <?php endforeach; ?>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-6 col-md-3 col-lg-2 mt-2">
          <button class="btn btn-primary text-uppercase pt-2 pb-2 col-12" onclick="guardarDatosGenerales()">Guardar</button>
        </div>
        <div class="col-6 col-md-3 col-lg-2 mt-2">
          <a href="datoEquipo.php" class="text-decoration-none"><button class="btn btn-primary text-uppercase pt-2 pb-2 col-12">Siguiente</button></a>
        </div>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-kenU1KFdBIe4zVF0s0G1M5b4hcpxyD9F7jL+XkgmrxLMn5tnt+EnQ9IOnH+Ac1F" crossorigin="anonymous"></script>
